...
@Injectable()
export class NegotiationEnhancedGateway {
    private logger = new Logger('NegotiationEnhancedGateway');
    ...
    private setupSocketListeners() {
        this.server.on('connection', (client) => {
            this.logger.log(`Client connected to NegotiationEnhancedGateway: ${client.id}`);
